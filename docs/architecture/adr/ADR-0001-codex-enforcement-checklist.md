...
| EC-03 | No duplicate layouts | Existing public/auth/role layout ownership is reused | Parallel public, auth, provider, client, or admin layout system | Stop; inspect layout ownership and source locks |
...
| EC-11 | No duplicate dashboard shell | Existing role wrapper and SidebarCore contracts are preserved | New dashboard shell, sidebar engine, or role-policy wrapper | Stop; inspect dashboard blast radius and reuse current shell |
