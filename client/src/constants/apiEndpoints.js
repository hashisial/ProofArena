export const API_ENDPOINTS = Object.freeze({
  ...
  PROFILE_ONBOARDING_PROGRESS: "/profile/me/onboarding-progress",
  PROFILE_OPEN_TO: "/profile/open-to",
  PROFILE_PUBLISH_STATE: "/profile/me/publish-state",
  PROFILE_PRIVACY: "/profile/privacy",
  PROFILE_PUBLIC_PREVIEW: "/profile/me/public-preview",
  PROFILE_SECTION: (sectionKey) => `/profile/me/section/${encodeURIComponent(sectionKey)}`,
  ...
  PROFILE_PUBLISHED_PUBLIC: (identifier) => `/profile/public/${encodeURIComponent(identifier)}`,
...
export const AUTH_API = Object.freeze({
  ...
  REFRESH_ALIAS: API_ENDPOINTS.REFRESH_TOKEN,
...
export const PROFILE_API = Object.freeze({
  ...
  ONBOARDING_PROGRESS: API_ENDPOINTS.PROFILE_ONBOARDING_PROGRESS,
  PUBLIC_PREVIEW: API_ENDPOINTS.PROFILE_PUBLIC_PREVIEW,
  PUBLISH_STATE: API_ENDPOINTS.PROFILE_PUBLISH_STATE,
  PRIVACY: API_ENDPOINTS.PROFILE_PRIVACY,
  PUBLIC_PROFILE: API_ENDPOINTS.PROFILE_PUBLIC_BY_USERNAME,
  PUBLISHED_PUBLIC_PROFILE: API_ENDPOINTS.PROFILE_PUBLISHED_PUBLIC,
  SECTION: API_ENDPOINTS.PROFILE_SECTION,
...
export const API_ENDPOINT_GROUPS = Object.freeze({
  ...
  PROFILE: Object.freeze({
    ...
    PUBLIC_PREVIEW: API_ENDPOINTS.PROFILE_PUBLIC_PREVIEW,
    PUBLISHED_PUBLIC: API_ENDPOINTS.PROFILE_PUBLISHED_PUBLIC,
    SECTION: API_ENDPOINTS.PROFILE_SECTION,
