      ...
      >
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="min-w-0">
            ...
            <h3 className="mt-3 text-xl font-black leading-tight text-[#1C1917]">
              {record.result}
            </h3>
          </div>
      ...
      <Container className="relative z-10">
        <MotionDiv {...getMotionProps(reduceMotion, 0)}>
          <div className="grid gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:items-end">
            ...
            <div className="premium-motion-card rounded-3xl border border-[#E7E5E4] bg-[#FAFAF9] p-5 sm:p-6">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:items-start">
          <MotionDiv {...getMotionProps(reduceMotion, 0.08)}>
            <div>
              ...
              <h2 className="mt-4 text-3xl font-black leading-tight text-[#1C1917] sm:text-4xl">
                Verified proof becomes reputation.
              </h2>
              <p className="mt-4 text-base leading-8 text-[#57534E] sm:text-lg">
                Every completed outcome can generate proof records that show
                what was delivered, how it was verified, and why the provider
                earned reputation.
              </p>

              <div className="mt-8 rounded-3xl border border-[#E7E5E4] bg-white p-5 shadow-[0_20px_64px_rgba(28, 25, 23, 0.06)]">
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-black text-[#1C1917]">Proof status pipeline</p>
                      <p className="text-sm leading-6 text-[#78716C]">Submitted evidence becomes history after review.</p>
                    </div>
                  </div>
                ...
                <div className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
                  {pipeline.map((step, index) => (
                    <div className="premium-motion-row relative rounded-2xl border border-[#E7E5E4] bg-[#FAFAF9] p-4" key={step}>
                      <span className="grid h-9 w-9 place-items-center rounded-xl bg-white text-sm font-black text-[#365314]">
                        {index + 1}
                      </span>
