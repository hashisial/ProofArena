    ...
    <section className="relative overflow-hidden bg-[linear-gradient(180deg,#FFFFFF_0%,#FFFFFF_40%,#FEFCE8_100%)] py-16 sm:py-20 lg:py-24">
      ...
      <Container className="relative z-10">
        ...
        >
          <div
            aria-hidden="true"
            className="absolute inset-0 bg-[radial-gradient(circle_at_18%_4%,rgba(255,255,255,0.24),transparent_28%),radial-gradient(circle_at_86%_72%,rgba(161,98,7,0.28),transparent_30%)]"
          />
          <div aria-hidden="true" className="absolute inset-x-6 bottom-6 hidden flex-wrap justify-end gap-2 opacity-80 lg:flex">
            {decorativeBadges.map((item, index) => (
              <span
                className="rounded-full border border-white/15 bg-white/10 px-3 py-1.5 text-xs font-black text-[#F7FEE7] backdrop-blur"
                key={item}
          ...
          <div className="relative z-10 grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(260px,0.34fr)] lg:items-center">
            <div className="min-w-0 max-w-4xl">
              <div className="flex flex-wrap items-center gap-3">
                <span className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-white/10 text-[#ECFCCB]">
                  <ShieldCheck aria-hidden="true" className="h-5 w-5" />
                </span>
                <Badge className="border-white/15 bg-white/10 text-[#F7FEE7]" variant="outline">
              ...
              <p className="mt-5 text-sm font-bold leading-7 text-[#ECFCCB]">
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
                ...
                <a
                  className="inline-flex min-h-12 w-full max-w-full items-center justify-center rounded-full px-4 text-center text-sm font-black text-[#F7FEE7] underline-offset-4 transition hover:bg-white/10 hover:text-white hover:underline focus:outline-none focus:ring-2 focus:ring-[#ECFCCB]/80 sm:w-auto"
              ...
              {[
                ...
                return (
                  <div
                    ...
                    key={item.label}
                  >
                    <Icon aria-hidden="true" className="h-5 w-5 shrink-0 text-[#ECFCCB]" />
