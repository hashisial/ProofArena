...
export function ProviderBestMatchHighlight({ match }) {
  ...
  return (
    <Card
      ...
      className="border-[#3F6212]/25 bg-[linear-gradient(135deg,#f7fee7,#ffffff)] shadow-[0_24px_70px_rgba(63,98,18,0.12)]"
      padding="lg"
      variant="bordered"
    >
      <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
        <div className="min-w-0">
          <p className="flex items-center gap-2 text-xs font-black uppercase tracking-[0.16em] text-[#3F6212]">
            <Sparkles aria-hidden="true" className="h-4 w-4" />
            Best opportunity right now
          </p>
          <h2 id="provider-best-match-title" className="mt-3 break-words text-2xl font-black text-[#1C1917] sm:text-3xl">
            {challenge.title || "Matched challenge"}
          </h2>
          <p className="mt-3 max-w-3xl break-words text-sm font-bold leading-6 text-[#44403C]">
