...
function Metric({ label, value }) {
  return (
    <div className="rounded-xl border border-[#E9E2F3] bg-[#F8F4FF] px-3 py-3">
    ...
    <Card as="article" padding="md" variant="bordered">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="min-w-0">
          ...
          <h3 className="mt-3 break-words text-xl font-black tracking-normal text-[#07030D]">
      ...
      <div className="mt-5 rounded-2xl border border-[#E9E2F3] bg-white p-4">
        <p className="text-xs font-black uppercase tracking-[0.14em] text-[#7C3AED]">Next action</p>
        <p className="mt-2 text-sm font-black text-[#07030D]">{nextAction.label}</p>
        <p className="mt-1 text-sm leading-6 text-[#6F657C]">{nextAction.description}</p>
      </div>
