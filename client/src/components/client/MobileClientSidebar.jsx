...
export function MobileClientSidebar() {
  ...
  useEffect(() => {
    ...
    const focusTimer = window.setTimeout(() => {
      document.getElementById("client-sidebar")?.focus({ preventScroll: true });
    }, 0);
  ...
  return (
    <>
      <button
        ...
        type="button"
      />
      <ClientSidebar isMobileOpen={isMobileOpen} variant="mobile" />
    </>
  );
}
