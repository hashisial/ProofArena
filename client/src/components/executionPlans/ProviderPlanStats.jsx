  ...
  return (
    <section aria-labelledby="provider-plan-stats-title">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          <p className="text-xs font-black uppercase tracking-[0.16em] text-[#7C3AED]">Performance overview</p>
          <h2 className="mt-2 text-2xl font-black text-[#07030D]" id="provider-plan-stats-title">
            Acquisition results at a glance
          </h2>
        </div>
        <p className="max-w-md text-sm leading-6 text-[#6F657C]">
        ...
        {items.map(([label, value]) => (
          <Card key={label} padding="sm" variant="muted">
            ...
            {isLoading ? (
              ...
              <p className="mt-2 break-words text-3xl font-black text-[#07030D]">
